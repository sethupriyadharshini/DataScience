...
class Univariate():
    ...
    def dataFrameTable(dataset,quan):
        descriptive = pd.DataFrame(index=['Mean','Median','Mode','Min','Q1-25%','Q2-50%','Q3-75%','99th','Q4-100%','IQR','1.5rule','Lesser','min','max','Greater','Skew','Kurtosis'],columns=quan) #it creates table with given index value in row and column value
